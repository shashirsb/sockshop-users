...
public class AtpSodaUserRepository extends DefaultUserRepository {
	...
	public User getOrCreate(String id) {
		return Optional.ofNullable(findUser(id)).orElse(new User(id));
	}
	...
	public User removeUser(String id) {
		...
		if (user != null) {
			try {
				...
				OracleDocument filterSpec = this.db.createDocumentFromString("{ \"username\" : \"" + id + "\"}");
	...
	private User findUser(String userID) {
		...
		try {
			...
			OracleDocument filterSpec = this.db.createDocumentFromString("{ \"username\" : \"" + userID + "\"}");
